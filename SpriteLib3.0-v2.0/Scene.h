...
public:
	...
	unsigned int CreatePhysicsSpritetoControl(bool stad, bool circle, bool square, std::string name, int width, int height, int layer, float posX, float posY, int angle, float transparency, float friction, float density);
	//Gamepad Input
